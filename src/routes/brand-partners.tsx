        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {partners.map((p) => (
            ...
            >
              ...
              <h3 className="mt-4 text-lg font-bold text-foreground group-hover:text-primary transition-premium">
                {p.name}
              </h3>
              <p className="mt-1.5 text-xs font-medium text-muted-foreground leading-relaxed px-4">
                {p.desc}
              </p>
      ...
      <Section>
        <div className="max-w-4xl mx-auto rounded-3xl bg-primary p-8 sm:p-12 text-center text-primary-foreground shadow-glow animate-fade-up">
          <h2 className="text-3xl font-bold tracking-tight mb-4">
            Looking for a specific OEM solution?
          </h2>
          <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Our network extends beyond our primary partners. Contact us to discuss your specific
            technological or appliance requirements.
          </p>
          <Button
            asChild
            size="lg"
