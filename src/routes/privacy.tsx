      ...
      <Section>
        <div className="max-w-4xl mx-auto space-y-12 text-foreground/90">
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Heemo India respects your privacy and is committed to protecting the information you
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              This website may use basic cookies and analytics tools to improve functionality,
              performance, and user experience.
            </p>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              These technologies help us understand website usage patterns and improve the overall
              user experience.
            </p>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              We implement reasonable administrative and technical measures intended to safeguard
              personal information against unauthorized access, disclosure, or misuse.
            </p>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              Information is retained only for as long as reasonably necessary to respond to
              enquiries, provide services, maintain business records, or comply with applicable
              legal requirements.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              Information may be shared with service providers, logistics partners, OEM partners, or
              legal authorities only where reasonably necessary to:
            </p>
            <ul className="list-disc list-inside pl-4 space-y-2 text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              You may request correction, updating, or deletion of personal information previously
              submitted through this website by contacting us using the details provided below.
            </p>
          </div>
